...
type GroupItem struct {
	...
	ThinkingLevel string `json:"thinking_level"`                                                  // ThinkingLevel 覆盖该项的推理强度，default 保留客户端设置。
}
...
type GroupItemAddRequest struct {
	...
	ThinkingLevel string `json:"thinking_level"`                // ThinkingLevel 是该项的推理强度覆盖。
}
...
type GroupItemUpdateRequest struct {
	...
	ThinkingLevel *string `json:"thinking_level,omitempty"` // ThinkingLevel 是新的推理强度覆盖。
}
