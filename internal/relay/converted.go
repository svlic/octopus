...
func (f *forwarder) executeConverted(ctx context.Context, modelName, thinkingLevel string, channel *model.Channel) upstreamResult {
	...
	if thinkingLevel != "" && thinkingLevel != "default" {
		request.ReasoningEffort = thinkingLevel
